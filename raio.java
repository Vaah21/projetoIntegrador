...
public class raio {
    ...
    public raio(Context context) {
        spike[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.raio);
        spike[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.raio);
        spike[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.raio);
        random = new Random();
        resetPosition();
    }
